...
while True:
    ...
    if rand == 0:
        ...
        os.system('curl -k "http://admin:@192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=1"')
    if rand == 1:
        # down
        # r = requests.get("http://192.168.0.20/pantiltcontrol.cgi")
        # r = requests.get("http://192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=7")
        os.system('curl -k "http://admin:@192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=7"')
    if rand == 2: 
        # left
        # r = requests.get("http://192.168.0.20/pantiltcontrol.cgi")
        # r = requests.get("http://192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=3")
        os.system('curl -k "http://admin:@192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=3"')
    if rand == 3:
        # right
        ...
        os.system('curl -k "http://admin:@192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=5"')
    if rand == 4:
        # home
        ...
        os.system('curl -k "http://admin:@192.168.0.20/pantiltcontrol.cgi?PanSingleMoveDegree=5&TiltSingleMoveDegree=5&PanTiltSingleMove=4"')
    time.sleep(5)
